...
#REPO="https://raw.githubusercontent.com/Andyyuda/scriptvps/main/"

###
BURIQ () {
    curl -sS https://raw.githubusercontent.com/Andyyuda/permission/main/tai > /root/tmp
...
Name=$(curl -sS https://raw.githubusercontent.com/Andyyuda/permission/main/tai | grep $MYIP | awk '{print $2}')
...
PERMISSION () {
    MYIP=$(curl -sS ipv4.icanhazip.com)
    IZIN=$(curl -sS https://raw.githubusercontent.com/Andyyuda/permission/main/tai | awk '{print $4}' | grep $MYIP)
    if [ "$MYIP" = "$IZIN" ]; then
    Bloman
    else
...
sleep 2
clear
wget https://raw.githubusercontent.com/Andyyuda/tai/main/ssh/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
#Instal Xray
...
clear
wget https://raw.githubusercontent.com/Andyyuda/tai/main/websocket/insshws.sh && chmod +x insshws.sh && ./insshws.sh
clear
wget https://raw.githubusercontent.com/Andyyuda/tai/main/websocket/nontls.sh && chmod +x nontls.sh && ./nontls.sh
clear
# Pasang SlowDNS
...
sleep 2
wget -q -O taimenu.sh https://raw.githubusercontent.com/Andyyuda/tai/main/menu/taimenu.sh && chmod +x taimenu.sh && ./taimenu.sh
clear
ln -fs /usr/share/zoneinfo/Asia/Jakarta /etc/localtime
clear
cat> /root/.profile << END
